...
The case has to be made carefully. Manufacturing policy fails when it becomes an excuse for discretionary allocation, protected incumbents, land arbitrage, or patriotic rhetoric without productivity discipline. The policy proposed here works in the opposite direction. It asks the state to do fewer discretionary things and a few harder measurable things: stop taxing qualifying new manufacturing profits, publish factory-time, audit value addition and payroll, revoke eligibility when conditions fail, and coordinate states around land, power, logistics, and customs.

The paper develops the argument through five bodies of evidence. Greenwald and Stiglitz provide the learning-externality foundation. Hausmann and Hidalgo discipline sector choice through capability adjacency. Hsieh and Klenow turn India's missing middle into a misallocation problem. Rodrik supplies the urgency through premature deindustrialization. Lane, Juhasz, Liu, Khan, Kelkar-Shah, Pritchett, Besley-Burgess, Studwell, and Corden provide the empirical, political-economy, and trade-theory constraints that keep the proposal from becoming industrial romanticism.
...
The trade deficit with China is often treated as a macro statistic or a nationalist talking point. For manufacturing policy, the concrete reading matters more. A persistent goods deficit is also a measure of production capability accumulating outside India. The consumer receives the product, but India does not receive the wage pool, supplier network, production learning, or crisis option.
...
Vietnam shows the FDI path. Its manufacturing growth came through openness to global manufacturers, export discipline, industrial zones, and integration into electronics and apparel supply chains. India cannot become Vietnam by slogan. It must compete on factory-time, land, customs reliability, and supplier response. The relevant benchmark is whether a global manufacturer can move from decision to production faster in India than in Vietnam.
...
Corruption is a manufacturing tax on time, uncertainty, and scale. For this paper, corruption means an unofficial payment, kickback, coerced facilitation payment, politically mediated favor, or discretionary harassment attached to a state-controlled business transaction. The main transaction points are land, utilities, permits, customs, inspections, procurement, and refunds. Lawful taxes, published fees, and legitimate safety or environmental compliance are outside the definition.
...
The federal design also protects the libertarian part of the doctrine. Instead of a central ministry deciding every project, firms choose among states competing on operating quality. The central state sets the tax rule and measurement architecture; the states win by cutting factory-time.

## 15. Strategic Capacity as Real Option

Some manufacturing capacity has option value beyond current output. APIs, mature-node semiconductors, rare earths, telecom equipment, and batteries may matter most during crisis. The value of domestic capacity rises under supply shock, sanctions, war, pandemic, export controls, or geopolitical coercion.
...
Labor advocates worry that manufacturing competitiveness can become a race to the bottom. That would be a failure. Labor flexibility belongs with formal payroll, safety enforcement, skill formation, worker housing, and portable benefits. The objective is productive labor in firms that can scale.
...
India's manufacturing problem requires a different settlement: markets for firms, discipline for beneficiaries, measurement for states, and a tax system that does not punish new industrial capacity before it has time to compound.
